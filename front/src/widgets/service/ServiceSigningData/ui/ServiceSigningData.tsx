...
import { ServiceSigning } from '~entities/service/ServiceSigning';

export const ServiceSigningData = () => {
  const breadcrumbItems = [
    ...
    // },
    {
      title: <div className="text-black text-[14px]">Запись на сервис</div>,
    },
  ];
  ...
  return (
    <div className="grid grid-cols-12 sm:grid-cols-8 xs:grid-cols-4 gap-[60px] p-[60px_20px_100px] max-w-[1024px] mx-auto w-full">
      ...
      />
      <h1 className="col-span-12 sm:col-span-8 xs:col-span-4 text-[58px] font-semibold">
        Запись на сервис
      </h1>
      <ServiceSigning />
    </div>
