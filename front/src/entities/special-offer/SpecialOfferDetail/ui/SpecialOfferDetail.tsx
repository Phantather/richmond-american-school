...
import testDrive from '~shared/assets/test-drive.png';
import { useWindowInnerWidth } from '~shared/ui';
import { NewsDetailItem } from '~entities/news';
import { dayjs } from '~shared/lib/time/dayjs';

export interface SpecialOfferDetailProps {
  newsDetail: NewsDetailItem;
}

export const SpecialOfferDetail: FC<SpecialOfferDetailProps> = ({ newsDetail }) => {
