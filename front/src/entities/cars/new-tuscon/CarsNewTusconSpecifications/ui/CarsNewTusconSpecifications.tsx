...
export interface CarsNewTusconSpecificationsProps {}

export const CarsNewTusconSpecifications: FC<CarsNewTusconSpecificationsProps> = () => {
    ...
    <div className="grid grid-cols-12 pt-[60px]">
      ...
      <div className="col-span-12 grid grid-cols-12 items-center my-[40px] sm:gap-10">
        ...
        <div className="col-span-7 sm:col-span-12">
          ...
          >
            <Select.Option value={0}>Smartstream G2.0 MPI ( Standard ) </Select.Option>
          </Select>
        </div>
      </div>
