...
export interface CarsNewTusconPriceProps {
  list?: FilePriceItem[];
}

export const CarsNewTusconPrice: FC<CarsNewTusconPriceProps> = ({ list }) => {
  return (
    <div className="grid grid-cols-12 pt-[60px]">
      <div className="col-span-12 grid grid-cols-12 bg-primary text-white py-[10px]">
        <div className="col-span-8 text-center">Новый TUCSON</div>
