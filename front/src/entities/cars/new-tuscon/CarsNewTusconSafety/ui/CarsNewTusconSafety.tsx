...
import safety1 from '~shared/assets/new-tuscon/safety1.jpg';
import safety2 from '~shared/assets/new-tuscon/safety2.jpg';
import safety3 from '~shared/assets/new-tuscon/safety3.jpg';
import safety4 from '~shared/assets/new-tuscon/safety4.jpg';
...
export interface CarsNewTusconSafetyProps {}

export const CarsNewTusconSafety: FC<CarsNewTusconSafetyProps> = () => {
  ...
  return (
    <div className="grid grid-cols-12 sm:grid-cols-8 xs:grid-cols-4  pt-[60px]">
      <h2 className="col-span-12 sm:col-span-8 xs:col-span-4 text-[48px] font-medium text-center mb-[40px]">
        Обеспечьте себе безопасность со всех сторон
      </h2>
      {windowWidth <= 768 && (
      ...
      <div className="col-span-6 sm:col-span-8 xs:col-span-4  max-h-[360px]">
        <img src={safety1} alt="new_tuscon" className="w-full h-full" />
      </div>
      {windowWidth > 768 && (
      ...
      <div className="col-span-6 sm:col-span-8 xs:col-span-4  max-h-[360px]">
        <img src={safety2} alt="new_tuscon" className="w-full h-full" />
      </div>
      {windowWidth <= 768 && (
        <div className="col-span-6 sm:col-span-8 xs:col-span-4  p-[24px_0]">
      ...
      <div className="col-span-6 sm:col-span-8 xs:col-span-4  max-h-[360px]">
        <img src={safety3} alt="new_tuscon" className="w-full h-full" />
      </div>
      {windowWidth > 768 && (
        <div className="col-span-6 sm:col-span-8 xs:col-span-4  p-[24px]">
          <h3 className="text-[30px]">Система кругового обзора</h3>
      ...
      <div className="col-span-6 sm:col-span-8 xs:col-span-4  max-h-[360px]">
        <img src={safety4} alt="new_tuscon" className="w-full h-full" />
      </div>
      ...
      <div className="col-span-12 sm:col-span-8 xs:col-span-4  grid grid-cols-12 sm:grid-cols-8 xs:grid-cols-4 gap-x-6 gap-y-10">
        <div className="col-span-6 sm:col-span-8 xs:col-span-4 ">
          <img src={safety5} alt="new_tuscon" className="w-full max-h-[360px]" />
        ...
        <div className="col-span-6 sm:col-span-8 xs:col-span-4 ">
          <img src={safety6} alt="new_tuscon" className="w-full max-h-[360px]" />
        ...
        <div className="col-span-6 sm:col-span-8 xs:col-span-4 ">
          <img src={safety7} alt="new_tuscon" className="w-full max-h-[360px]" />
        ...
        <div className="col-span-6 sm:col-span-8 xs:col-span-4 ">
          <img src={safety8} alt="new_tuscon" className="w-full max-h-[360px]" />
        ...
        <div className="col-span-6 sm:col-span-8 xs:col-span-4 ">
          <img src={safety9} alt="new_tuscon" className="w-full max-h-[360px]" />
        ...
        <div className="col-span-6 sm:col-span-8 xs:col-span-4 ">
          <img src={safety10} alt="new_tuscon" className="w-full max-h-[360px]" />
